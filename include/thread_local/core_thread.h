...
constexpr int MAX_STEAL_RANGE{2}; // 最大窃取范围
constexpr int MAX_BACTH_SIZE{2};  // 获取任务的最大数量
...
class CoreThread {
 ...
 private:
  ...
  std::vector<std::shared_ptr<CoreThread>>  core_thread_vector_; //核心线程队列，在这里用于任务窃取
};
